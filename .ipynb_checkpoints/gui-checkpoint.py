# gui.py (Phase-5 Final — auto-save reports & graphs to Documents/EncryptEase_Reports)
...
# Matplotlib for embedded graphs (optional)
try:
    import matplotlib
...
class EncryptEaseApp:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("🔐 Encrypt-Ease (Final Auto-Save)")
    ...
    def main_screen(self):
        ...
        # ✅ Show ✓ tick symbol instead of default box behavior
        def toggle_tick():
